...
shp_az_adwr_gwbasins_utm12n_nad83 = os.path.join(nwm_az_const_dir,'basins/ADWR_Groundwater_Subbasin_2024.shp') #not using this - changed the path in 03_postproc_gwbasin_stats.py
#------------------------------------------------------------------------------
